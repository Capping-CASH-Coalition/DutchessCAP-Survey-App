webpackJsonp([0,11],Array(252).concat([
/* 252 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__graphs_component__ = __webpack_require__(260);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__graphs_routes__ = __webpack_require__(393);
...
GraphsModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* RouterModule */].forChild(__WEBPACK_IMPORTED_MODULE_5__graphs_routes__["a" /* graphsRoutes */])
        ],
        declarations: [
            __WEBPACK_IMPORTED_MODULE_4__graphs_component__["a" /* GraphsComponent */]
        ],
    })
], GraphsModule);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_chart_js__ = __webpack_require__(399);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_chart_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_chart_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__graphData_component__ = __webpack_require__(392);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__chartType_component__ = __webpack_require__(391);
...
var GraphsComponent = (function () {
    function GraphsComponent() {
        this.chartDataFilters = [];
        this.chartTypes = [];
        this.chartTypesObj = [];
        //Chart Object
        this.chart = null;
        //Chart Data (Initialize it here with a length of 1 so don't get undefined error)
        this.chartDataArr = new Array(1);
        this.chartOptions = {
            responsive: false
        };
    }
    GraphsComponent.prototype.ngOnInit = function () {
        this.chartFiltersForm = new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["c" /* FormGroup */]({
            graphType: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["d" /* FormControl */](this.chartTypes[0]),
            filterTopLevel: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["d" /* FormControl */](),
            filterSubLevel: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["d" /* FormControl */]()
        });
    ...
    ;
    GraphsComponent.prototype.initChartTypes = function () {
        var ct;
        ct = new __WEBPACK_IMPORTED_MODULE_4__chartType_component__["a" /* ChartType */]("pie", "Pie");
        this.chartTypesObj[0] = ct;
        ct = new __WEBPACK_IMPORTED_MODULE_4__chartType_component__["a" /* ChartType */]("bar", "Bar");
        this.chartTypesObj[1] = ct;
        ct = new __WEBPACK_IMPORTED_MODULE_4__chartType_component__["a" /* ChartType */]("doughnut", "Doughnut");
        this.chartTypesObj[2] = ct;
        ct = new __WEBPACK_IMPORTED_MODULE_4__chartType_component__["a" /* ChartType */]("polarArea", "Polar Area");
        this.chartTypesObj[3] = ct;
        ct = new __WEBPACK_IMPORTED_MODULE_4__chartType_component__["a" /* ChartType */]("line", "Line");
        this.chartTypesObj[4] = ct;
        ct = new __WEBPACK_IMPORTED_MODULE_4__chartType_component__["a" /* ChartType */]("radar", "Radar");
        this.chartTypesObj[5] = ct;
        this.chartTypes = this.getAllFormatedChartTypes();
    };
    GraphsComponent.prototype.getAllFormatedChartTypes = function () {
        var res = [];
        this.chartTypesObj.forEach(function (obj) {
            res.push(obj.displayFormat);
        });
        return res;
    };
    GraphsComponent.prototype.getChartJSChartType = function (ct) {
        for (var i = 0; i < this.chartTypesObj.length; i++) {
            if (this.chartTypesObj[i].displayFormat === ct) {
                return this.chartTypesObj[i].chartFormat;
            }
        }
    };
    GraphsComponent.prototype.updateTopFilter = function (filter) {
    ...
    GraphsComponent.prototype.updateSubFilter = function (filter) {
        if (this.currDataFilterSubLevel != filter) {
            this.currDataFilterSubLevel = filter;
        }
    };
    GraphsComponent.prototype.updateChartType = function (chartType) {
        if (this.currChartType != chartType) {
            this.currChartType = this.getChartJSChartType(chartType);
            this.generateChart();
        }
    };
    GraphsComponent.prototype.updateCurrCharDataLabels = function (filter) {
        var gd = this.getGraphDataFromDataArray(filter);
        this.currDataSetData = gd.data;
        this.currDataLabels = gd.labels;
    };
    GraphsComponent.prototype.generateChart = function () {
        this.chart.destroy();
    ...
    GraphsComponent.prototype.getDataFilters = function () {
        return ['Age', 'Language', 'Gender', 'Location', 'Experience'];
    };
    GraphsComponent.prototype.initChartGlobals = function (gd) {
        this.currChartType = 'pie';
        this.currDataLabels = gd.labels;
        this.currDataSetData = gd.data;
    };
    GraphsComponent.prototype.getCurrChartGlobals = function () {
        var c = new __WEBPACK_IMPORTED_MODULE_1_chart_js__["Chart"](this.ctx, {
    ...
    GraphsComponent.prototype.addToDataArray = function (key, labels, data) {
        var gd = new __WEBPACK_IMPORTED_MODULE_3__graphData_component__["a" /* GraphData */](key, labels, data);
        this.chartDataArr.push(gd);
    };
    GraphsComponent.prototype.getGraphDataFromDataArray = function (key) {
        for (var i = 0; i < this.chartDataArr.length; i++) {
...
/* MIT license */
var cssKeywords = __webpack_require__(265);
...
;(function (global, factory) {
    true ? factory(__webpack_require__(256)) :
...
var ChartType = (function () {
    function ChartType(chartFormat, displayFormat) {
...
//# sourceMappingURL=chartType.component.js.map
...
var GraphData = (function () {
    function GraphData(key, labels, data) {
        this.key = key;
        this.labels = labels;
        this.data = data;
    }
...
//# sourceMappingURL=graphData.component.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__graphs_component__ = __webpack_require__(260);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return graphsRoutes; });

var graphsRoutes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_0__graphs_component__["a" /* GraphsComponent */]
    },
];
//# sourceMappingURL=graphs.routes.js.map
 ...
 * @namespace Chart
 */
var Chart = __webpack_require__(419)();
...
var color = __webpack_require__(438);
...
/* MIT license */
var colorNames = __webpack_require__(265);
...
/* MIT license */
var convert = __webpack_require__(439);
var string = __webpack_require__(437);
...
var conversions = __webpack_require__(264);
var route = __webpack_require__(440);
