...
var GraphsComponent = (function () {
    ...
    GraphsComponent.prototype.initOptionsForm = function () {
        ...
        this.optionsForm = this.fb.group({
            options: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* FormArray */](controls)
        });
    };
...
var InputComponent = (function () {
    function InputComponent(router, surveyService, changeref, auth) {
        this.router = router;
        this.surveyService = surveyService;
        this.changeref = changeref;
        this.auth = auth;
...
var SurveyComponent = (function () {
    function SurveyComponent(router, _fb, surveyService, changeref, auth) {
        this.router = router;
        this._fb = _fb;
        this.surveyService = surveyService;
        this.changeref = changeref;
    ...
    SurveyComponent.prototype.createLoginFormGroup = function () {
        this.loginFormGroup = this._fb.group({
            username: new __WEBPACK_IMPORTED_MODULE_4__angular_forms__["c" /* FormControl */](''),
            password: new __WEBPACK_IMPORTED_MODULE_4__angular_forms__["c" /* FormControl */]('')
        });
    };
    SurveyComponent.prototype.isAuthenticated = function () {
    ...
    SurveyComponent.prototype.setLoginModal = function () {
...
SurveyComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* Router */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4__angular_forms__["d" /* FormBuilder */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_forms__["d" /* FormBuilder */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__services_survey_service__["a" /* SurveyService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_survey_service__["a" /* SurveyService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["ChangeDetectorRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["ChangeDetectorRef"]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_1__services_authentication_service__["a" /* AuthenticationService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_authentication_service__["a" /* AuthenticationService */]) === "function" && _e || Object])
], SurveyComponent);
...
var SurveyService = (function () {
    ...
    */
    ...
    SurveyService.prototype.getUserPassword = function (username) {
        return this.http.get('http://localhost:8888/api/userPassword/' + username, { observe: 'response' });
    };
    /*
      Post functions
    */
